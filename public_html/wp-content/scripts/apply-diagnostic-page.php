...
<a href="#cta" style="display:inline-block;background:#F5A623;color:#1A202C;padding:16px 32px;border-radius:12px;text-decoration:none;font-weight:600;font-size:16px;">Разобрать продажу с агентом</a>
...
<button type="submit" class="btn-submit" data-label="Разобрать продажу с агентом" style="background:#F5A623;color:#1A202C;padding:16px 32px;border-radius:12px;border:none;font-weight:600;font-size:16px;cursor:pointer;">
Разобрать продажу с агентом
</button>
</div>
</div>
</form>
