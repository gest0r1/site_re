...
<form data-stage="2" data-action="prepare" style="display:flex;flex-direction:column;gap:16px;" onsubmit="return false;">
...
<option>Получить чек-лист подготовки</option>
<option>Разобрать квартиру с агентом</option>
...
<button type="submit" class="btn-submit" data-label="Записаться на консультацию" style="background:#F5A623;color:#1A202C;padding:16px 32px;border-radius:12px;border:none;font-weight:600;font-size:16px;cursor:pointer;">
