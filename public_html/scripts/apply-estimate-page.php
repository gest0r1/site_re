...
<p style="font-size:15px;font-weight:600;color:#172033;margin:8px 0 4px;">Ваши контакты</p>
...
<button type="submit" style="background:#F5A623;color:#1A202C;padding:16px 32px;border-radius:12px;border:none;font-weight:600;font-size:16px;cursor:pointer;width:100%;">
