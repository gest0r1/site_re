...
<input type="text" placeholder="Имя" required style="padding:14px 16px;border-radius:8px;border:none;font-size:16px;background:#FFFFFF;color:#172033;">
<input type="tel" placeholder="Телефон" required style="padding:14px 16px;border-radius:8px;border:none;font-size:16px;background:#FFFFFF;color:#172033;">
...
<button type="submit" style="background:#F5A623;color:#1A202C;padding:16px 32px;border-radius:8px;border:none;font-weight:600;font-size:16px;cursor:pointer;">Обсудить продажу</button>
</form>
